...
export function handleReceiveDecks() {
    return (dispatch) => {   _getDecks().then(decks => {
...
export function addDeck(deck) {
   ...
   export function handleAddDeck(title) {
    return (dispatch) => { _addDeck(title).then((deck) => dispatch(addDeck(deck)))
    }
}
...
export function handleDeleteDeck(deckId) {
    return (dispatch) => {  _deleteDeck(deckId).then(() => dispatch(deleteDeck(deckId)));
    }
}
